...
export const INNOVATION_PROJECTS: ProjectVideo[] = [
  ...
  {
    id: "proj-7",
    title: "RescueIQ | AI-Powered Emergency Response & Disaster Management System | Student Innovation Project",
    videoId: "https://youtu.be/yInNRKj1wL4?si=OJ74wOp2MYvY5in-", // Reusing a valid placeholder
    students: ["Ruthiksha", "Rajasri","Pooja"],
    description: "🚨 RescueIQ is an innovative AI-powered emergency response and disaster management system designed to improve emergency preparedness, accelerate rescue operations, and provide real-time assistance during critical situations.\nBy integrating Artificial Intelligence (AI), real-time analytics, and intelligent decision-making, RescueIQ helps emergency responders and authorities coordinate rescue efforts efficiently while enhancing public safety.RescueIQ demonstrates how AI and smart technologies can revolutionize emergency response by enabling faster decision-making, improving coordination, and helping save lives during emergencies and disasters.\n#RescueIQ #ArtificialIntelligence #MachineLearning #DisasterManagement #EmergencyResponse #AIProject #FinalYearProject #Python #Sustainability #FoodManagement #Innovation #StudentProject #TechForGood",
  },
  {
    id: "proj-8",
  ...
  {
    id: "proj-10",
    title: "MEDOVA | Predictive AI Healthcare & Smart Medical Ecosystem | Student Innovation Project",
    videoId: "https://youtu.be/EgRybVrFd_0", // Reusing a valid placeholder
    students: ["Harshini", "Shanmuga Priya","Udhaya Sri"],
    description: "🏥 MEDOVA - Predictive AI Healthcare & Ecosystem is an innovative AI-powered healthcare platform designed to transform the way healthcare is delivered through predictive analytics, intelligent patient monitoring, and a connected digital healthcare ecosystem.\nBy leveraging Artificial Intelligence (AI) and Machine Learning (ML), MEDOVA helps predict potential health risks, supports informed clinical decision-making, and promotes proactive patient care for improved healthcare outcomes.\nMEDOVA demonstrates how predictive AI and intelligent healthcare technologies can enhance patient care, improve medical decision-making, and build a smarter, more connected healthcare ecosystem for the future.\n#MEDOVA #ArtificialIntelligence #MachineLearning #HealthcareInnovation #StudentProject #Innovation #FinalYearProject #EngineeringProjects #ProjectShowcase #DigitalHealth",
  }
