          ...
          {EVENTS.map((e, i) => {
            ...
            return (
              <Reveal key={e.title} delay={i * 100}>
                <div className="group flex flex-col sm:flex-row items-start sm:items-center gap-6 rounded-2xl border border-border bg-card p-6 hover:border-brand hover:shadow-md transition">
